...
_CREATEBUCKETREQUEST = _descriptor.Descriptor(
  ...
  full_name='storage.CreateBucketRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='storage.CreateBucketRequest.name', index=0,
...
_BUCKETINFO = _descriptor.Descriptor(
  name='BucketInfo',
  full_name='storage.BucketInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='storage.BucketInfo.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='size', full_name='storage.BucketInfo.size', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='numObjects', full_name='storage.BucketInfo.numObjects', index=2,
...
_OBJECTINFO_METADATAENTRY = _descriptor.Descriptor(
  name='MetadataEntry',
  full_name='storage.ObjectInfo.MetadataEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='storage.ObjectInfo.MetadataEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='storage.ObjectInfo.MetadataEntry.value', index=1,
...
_OBJECTINFO = _descriptor.Descriptor(
  name='ObjectInfo',
  full_name='storage.ObjectInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='storage.ObjectInfo.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='created', full_name='storage.ObjectInfo.created', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='size', full_name='storage.ObjectInfo.size', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='storage.ObjectInfo.metadata', index=3,
...
_LISTBUCKETSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='storage.ListBucketsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='bucket', full_name='storage.ListBucketsResponse.bucket', index=0,
...
_LISTOBJECTSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='storage.ListObjectsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='prefix', full_name='storage.ListObjectsResponse.prefix', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='object', full_name='storage.ListObjectsResponse.object', index=1,
...
CreateBucketRequest = _reflection.GeneratedProtocolMessageType('CreateBucketRequest', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:storage.CreateBucketRequest)
  ))
...
BucketInfo = _reflection.GeneratedProtocolMessageType('BucketInfo', (_message.Message,), dict(
  ...
  __module__ = 'storage_pb2'
  # @@protoc_insertion_point(class_scope:storage.BucketInfo)
  ))
...
ObjectInfo = _reflection.GeneratedProtocolMessageType('ObjectInfo', (_message.Message,), dict(
  ...
  MetadataEntry = _reflection.GeneratedProtocolMessageType('MetadataEntry', (_message.Message,), dict(
    ...
    __module__ = 'storage_pb2'
    # @@protoc_insertion_point(class_scope:storage.ObjectInfo.MetadataEntry)
    ))
  ,
  DESCRIPTOR = _OBJECTINFO,
  __module__ = 'storage_pb2'
  # @@protoc_insertion_point(class_scope:storage.ObjectInfo)
  ))
...
ListBucketsResponse = _reflection.GeneratedProtocolMessageType('ListBucketsResponse', (_message.Message,), dict(
  ...
  __module__ = 'storage_pb2'
  # @@protoc_insertion_point(class_scope:storage.ListBucketsResponse)
  ))
...
ListObjectsResponse = _reflection.GeneratedProtocolMessageType('ListObjectsResponse', (_message.Message,), dict(
  ...
  __module__ = 'storage_pb2'
  # @@protoc_insertion_point(class_scope:storage.ListObjectsResponse)
  ))
