...
SubscribeTimeRequest = _reflection.GeneratedProtocolMessageType('SubscribeTimeRequest', (_message.Message,), {
...
_TIMEAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\212\222\003&\032!/api/instances/{instance}:setTime:\001*',
  ),
  _descriptor.MethodDescriptor(
    name='SubscribeTime',
