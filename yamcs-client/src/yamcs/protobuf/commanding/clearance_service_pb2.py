...
ListClearancesResponse = _reflection.GeneratedProtocolMessageType('ListClearancesResponse', (_message.Message,), {
...
ClearanceInfo = _reflection.GeneratedProtocolMessageType('ClearanceInfo', (_message.Message,), {
...
UpdateClearanceRequest = _reflection.GeneratedProtocolMessageType('UpdateClearanceRequest', (_message.Message,), {
...
DeleteClearanceRequest = _reflection.GeneratedProtocolMessageType('DeleteClearanceRequest', (_message.Message,), {
...
_CLEARANCEAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\212\222\003M*\032/api/clearances/{username}:\001*b,Clearance of \'{username}\' changed to {level}',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\212\222\003F\"\032/api/clearances/{username}b(Clearance revoked from user \'{username}\'',
  ),
  _descriptor.MethodDescriptor(
