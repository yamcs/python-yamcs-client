...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_REPLICATIONAPI']._loaded_options = None
  _globals['_REPLICATIONAPI']._serialized_options = b'\320\200\001\001'
  ...
  _globals['_REPLICATIONAPI']._serialized_end=867
