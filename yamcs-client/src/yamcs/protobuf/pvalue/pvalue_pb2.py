...
_RANGES_RANGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='start', full_name='yamcs.protobuf.pvalue.Ranges.Range.start', index=0,
...
_RANGES_RANGE.fields_by_name['stop'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
