...
_ROCKSDBAPI = _descriptor.ServiceDescriptor(
  ...
  file=DESCRIPTOR,
  index=0,
  serialized_options=b'\202\200\001\007RocksDB\320\200\001\001',
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=b'\212\222\003l\0324/api/archive/rocksdb/{tablespace}/{dbpath**}:compact:\001*H\001b/Compaction triggered on tablespace {tablespace}',
  ),
  _descriptor.MethodDescriptor(
