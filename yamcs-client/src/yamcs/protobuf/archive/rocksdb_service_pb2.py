...
_ROCKSDBAPI = _descriptor.ServiceDescriptor(
  ...
  file=DESCRIPTOR,
  index=0,
  serialized_options=_b('\202\200\001\010Rocks DB'),
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\212\222\003f\0322/api/archive/rocksdb/{tablespace}/{dbpath*}:backupb0Tablespace {tablespace} backed up to {backupDir}'),
  ),
  _descriptor.MethodDescriptor(
    name='ListDatabases',
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=_b('\212\222\003i\0324/api/archive/rocksdb/{tablespace}/{dbpath**}:compactH\001b/Compaction triggered on tablespace {tablespace}'),
  ),
  _descriptor.MethodDescriptor(
