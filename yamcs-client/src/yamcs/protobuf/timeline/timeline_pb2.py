...
_EXECUTIONSTATUS = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUCCEEDED', index=4, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_ABORTACTIVITYREQUEST = _descriptor.Descriptor(
  name='AbortActivityRequest',
  full_name='yamcs.protobuf.timeline.AbortActivityRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='instance', full_name='yamcs.protobuf.timeline.AbortActivityRequest.instance', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='item', full_name='yamcs.protobuf.timeline.AbortActivityRequest.item', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['AbortActivityRequest'] = _ABORTACTIVITYREQUEST
...
AbortActivityRequest = _reflection.GeneratedProtocolMessageType('AbortActivityRequest', (_message.Message,), {
  'DESCRIPTOR' : _ABORTACTIVITYREQUEST,
  '__module__' : 'yamcs.protobuf.timeline.timeline_pb2'
  # @@protoc_insertion_point(class_scope:yamcs.protobuf.timeline.AbortActivityRequest)
  })
_sym_db.RegisterMessage(AbortActivityRequest)
...
_TIMELINEAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='AbortActivity',
    full_name='yamcs.protobuf.timeline.TimelineApi.AbortActivity',
    index=20,
    containing_service=None,
    input_type=_ABORTACTIVITYREQUEST,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=b'\212\222\0035\0323/api/timeline/{instance}/items/{item}:abortActivity',
  ),
  _descriptor.MethodDescriptor(
