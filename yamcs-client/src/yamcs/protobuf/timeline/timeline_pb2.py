...
_TIMELINEITEM.fields_by_name['activityDefinition'].message_type = _ACTIVITYDEFINITIONINFO
...
_CREATEITEMREQUEST.fields_by_name['activityDefinition'].message_type = _ACTIVITYDEFINITIONINFO
