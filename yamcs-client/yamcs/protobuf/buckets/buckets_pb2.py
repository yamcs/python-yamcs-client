...
_BUCKETSAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\212\222\003\034\032\027/api/buckets/{instance}:\001*',
  ),
  _descriptor.MethodDescriptor(
    name='DeleteBucket',
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=b'\212\222\003&\"$/api/buckets/{instance}/{bucketName}',
  ),
  _descriptor.MethodDescriptor(
    name='GetObject',
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\212\222\003.\n,/api/buckets/{instance}/{bucketName}/objects',
  ),
  _descriptor.MethodDescriptor(
    name='DeleteObject',
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=b'\212\222\003<\":/api/buckets/{instance}/{bucketName}/objects/{objectName*}',
  ),
])
