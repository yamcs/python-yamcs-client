...
_COMMANDHISTORYSUBSCRIPTIONREQUEST.fields_by_name['commandId'].has_options = True
_COMMANDHISTORYSUBSCRIPTIONREQUEST.fields_by_name['commandId']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
