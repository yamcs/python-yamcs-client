...
Cop1SubscriptionRequest = _reflection.GeneratedProtocolMessageType('Cop1SubscriptionRequest', (_message.Message,), dict(
...
StreamSubscriptionRequest = _reflection.GeneratedProtocolMessageType('StreamSubscriptionRequest', (_message.Message,), dict(
