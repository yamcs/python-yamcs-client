...
_ROCKSDBAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\212\222\0034\0322/api/archive/rocksdb/{tablespace}/{dbpath*}:backup',
  ),
  _descriptor.MethodDescriptor(
    name='ListDatabases',
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=b'\212\222\0038\0324/api/archive/rocksdb/{tablespace}/{dbpath**}:compactH\001',
  ),
  _descriptor.MethodDescriptor(
