...
_COMMANDQUEUEENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='yamcsGenerationTime', full_name='yamcs.protobuf.commanding.CommandQueueEntry.yamcsGenerationTime', index=7,
...
_COMMANDQUEUEENTRY.fields_by_name['yamcsGenerationTime']._options = None
_COMMANDQUEUEENTRY.fields_by_name['generationTimeUTC']._options = None
