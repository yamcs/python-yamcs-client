...
_INSTANCETEMPLATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='variables', full_name='yamcs.protobuf.yamcsManagement.InstanceTemplate.variables', index=1,
