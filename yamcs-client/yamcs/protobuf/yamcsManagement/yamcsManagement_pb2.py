...
_YAMCSINSTANCE = _descriptor.Descriptor(
  ...
  nested_types=[_YAMCSINSTANCE_LABELSENTRY, ],
  enum_types=[
...
_INSTANCETEMPLATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='variable', full_name='yamcs.protobuf.yamcsManagement.InstanceTemplate.variable', index=1,
...
_TEMPLATEVARIABLE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='yamcs.protobuf.yamcsManagement.TemplateVariable.description', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='required', full_name='yamcs.protobuf.yamcsManagement.TemplateVariable.required', index=2,
...
_CLIENTINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='address', full_name='yamcs.protobuf.yamcsManagement.ClientInfo.address', index=3,
      number=10, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='instance', full_name='yamcs.protobuf.yamcsManagement.ClientInfo.instance', index=4,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='processorName', full_name='yamcs.protobuf.yamcsManagement.ClientInfo.processorName', index=5,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='yamcs.protobuf.yamcsManagement.ClientInfo.state', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='loginTime', full_name='yamcs.protobuf.yamcsManagement.ClientInfo.loginTime', index=7,
...
_EDITSERVICEREQUEST = _descriptor.Descriptor(
  ...
  full_name='yamcs.protobuf.yamcsManagement.EditServiceRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='instance', full_name='yamcs.protobuf.yamcsManagement.EditServiceRequest.instance', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='yamcs.protobuf.yamcsManagement.EditServiceRequest.name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='yamcs.protobuf.yamcsManagement.EditServiceRequest.state', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INSTANCETEMPLATE.fields_by_name['variable'].message_type = _TEMPLATEVARIABLE
...
EditServiceRequest = _reflection.GeneratedProtocolMessageType('EditServiceRequest', (_message.Message,), dict(
  ...
  __module__ = 'yamcs.protobuf.yamcsManagement.yamcsManagement_pb2'
  # @@protoc_insertion_point(class_scope:yamcs.protobuf.yamcsManagement.EditServiceRequest)
  ))
...
_MANAGEMENTAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='UpdateInstance',
    full_name='yamcs.protobuf.yamcsManagement.ManagementApi.UpdateInstance',
    index=6,
    containing_service=None,
    input_type=_EDITINSTANCEREQUEST,
    output_type=_YAMCSINSTANCE,
    serialized_options=_b('\212\222\003 *\031/api/instances/{instance}0\001:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='CreateInstance',
  ...
  _descriptor.MethodDescriptor(
    name='UpdateService',
    full_name='yamcs.protobuf.yamcsManagement.ManagementApi.UpdateService',
    index=15,
    containing_service=None,
    input_type=_EDITSERVICEREQUEST,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=_b('\212\222\003&*\037/api/services/{instance}/{name}0\001:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='ListLinks',
