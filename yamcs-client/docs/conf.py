...
htmlhelp_basename = 'YamcsPythonClientdoc'
...
latex_documents = [
    (master_doc, 'YamcsPythonClient.tex', u'Yamcs Python Client Documentation',
     u'Space Applications Services', 'manual'),
]
...
man_pages = [
    (master_doc, 'yamcspythonclient', u'Yamcs Python Client Documentation',
     [author], 1)
]
